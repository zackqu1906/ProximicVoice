"""Windows desktop output for streaming ASR.
...
focus, using Win32 Unicode keyboard events without replacing the clipboard.
macOS input is handled by the native input-method component.
"""
